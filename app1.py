...
def eda():
    ...
    status=st.checkbox('EDA on data by taking the Gender as a main column!')
    ...
    # Generate Sweetviz report comparing subsets based on condition
                ...
                st.info('When you run the aobe line of code in your host it will work. But unfortunately its not workign when we are deploying the application in stream cloud.')
                st.info('For the reference I attached that report in my git hub repo!')
